            ...
            <View style={styles.body}>    
                ...
                <View>
                    ...
                    <View style={{marginVertical:25}}>
                        ...
                        <Text style={{color:'#FFF',textAlign:'center', marginTop:20, fontSize:20}}>Forgot Password? <Text onPress={()=>navigation.replace('Sign In')} style={{color:'#FF5757'}}>Click here</Text></Text>
                    </View>
                </View>
